...
exports.ListenerProgram = void 0;
...
class ListenerProgram {
    static async handle(name) {
        ...
        if (checkFolder) {
            ...
            if (doesFileExist == false) {
                ...
                return baseCommand_1.default.error(name + "_listener.ts already exist. Modify listener name and try again");
            }
        }
    }
    static async nextStep(name) {
        fs_1.default.appendFile("./App/Listeners/" + name + "_listener.ts", this.generateListener(name), function (err) {
            ...
            baseCommand_1.default.success(name + "_listener.ts class successfully generated in App/Listeners folder");
            return true;
        });
    }
...
exports.ListenerProgram = ListenerProgram;

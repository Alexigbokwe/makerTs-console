...
class IdentityProgram {
    ...
    static async ProcessSqlIdentitySchema() {
    ...
    static async createSchemaFile(filename, generateSchema) {
        fs_1.default.appendFile(`./DataBase/Migrations/${filename}.ts`, generateSchema, function (err) {
            if (err) {
                spinner.color = "red";
                spinner.text = "failed";
                spinner.fail("");
            ...
            baseCommand_1.default.success(`${filename}.ts schema successfully generated in DataBase/Migrations folder`);
            return true;
        });
    }

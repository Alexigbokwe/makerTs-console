...
exports.ProviderProgram = void 0;
    ...
    static async handle(name) {
        ...
        if (checkFolder) {
            ...
            if (!doesFileExist) {
                ...
                return baseCommand_1.default.error(name + ".ts already exist. Modify service provider name and try again");
            }
        }
    }
...
exports.ProviderProgram = ProviderProgram;

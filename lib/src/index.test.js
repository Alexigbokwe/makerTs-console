...
const commandSwitch_1 = tslib_1.__importDefault(require("./commandSwitch"));
class Console {
    /**
     * Run Maker commands
     ...
     */
    static async run() {
        let commands = commandSwitch_1.default;
    ...
    checkCommandName(name) {
        if (typeof config_1.default.commands[name] == "string") {

...
commander_1.default.version("1.0.1").description("ExpressWebJs Command Line TS");
...
Console.ormRelated = ["commands/Domain/makeModel", "commands/sqlModel", "commands/Domain/makeDomain"];
